...
public class AgregarMedico implements Command {
    ...
    public AgregarMedico(IdentificacionMedico identificacionMedico, TipoDeIdentificacion tipoDeIdentificacion, Nombres nombres, Telefono telefono, RegistroMedico registroMedico, Especialidad especialidad) {
